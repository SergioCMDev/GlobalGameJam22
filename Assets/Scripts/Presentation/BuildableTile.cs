...
{
    public class BuildableTiles : Tile
    {
        ...
        public bool IsOccupied(ITilemap tilemap, Vector3Int position)
        {
...
// The following is a helper that adds a menu item to create a RoadTile Asset
        ...
        public static void CreateRoadTile()
        {
            ...
            if (path == "")
                return;
            AssetDatabase.CreateAsset(ScriptableObject.CreateInstance<BuildableTiles>(), path);
        }
#endif
    }
}